...
const rules = reactive<FormRules>({
  ...
  ownerName: [{ required: false, message: '请选择负责人', trigger: 'change' }],
  userName: [{ required: false, message: '请选择使用人', trigger: 'change' }],
  status: [{ required: false, message: '请选择状态', trigger: 'change' }],
  useStatus: [{ required: false, message: '请选择使用状态', trigger: 'change' }],
